# Home Search Map UX Principles KO

> KO 생성 기준: canonical source only
> Source: `.agents/skills/home-search-design/references/map-ux-principles.md`
> Generated: 2026-05-25
> 기존 KO 본문은 읽지 않고 canonical source만 기준으로 재생성했습니다.

## 동기화 기준

이 문서는 `.agents/skills/home-search-design/references/map-ux-principles.md`의 현재 canonical 내용을 기준으로 한 한국어 동기화본입니다.
