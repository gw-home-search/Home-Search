...
Instructions:
- Read root AGENTS.md, apps/property-data/AGENTS.md, CONTEXT.md, apps/property-data/CONTEXT.md, and relevant canonical docs before editing.
...
- Treat `cd apps/property-data && ./gradlew backendQualityCheck` as the backend canonical PR/CI gate.
