...
- 변경 후 가능한 backend 검증 명령과 git diff --check를 실행하라.
```
...
- correctness, public API compatibility, data safety, frontend map usability, security/secrets, missing tests를 확인하라.
