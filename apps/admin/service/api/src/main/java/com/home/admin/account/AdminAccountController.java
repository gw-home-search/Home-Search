...
public class AdminAccountController {
    ...
    @GetMapping
    public List<AdminAccountService.AccountSummary> accounts() {
    ...
    public ResponseEntity<AdminAccountService.AccountSummary> create(
        ...
        return ResponseEntity.created(URI.create("/api/v1/admin/accounts/" + created.accountId()))
                .body(created);
    }
    ...
    public ResponseEntity<Void> revokeSessions(
            @AuthenticationPrincipal AdminPrincipal actor, @PathVariable UUID accountId) {
