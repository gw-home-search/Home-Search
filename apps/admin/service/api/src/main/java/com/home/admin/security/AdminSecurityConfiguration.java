...
public class AdminSecurityConfiguration {
    ...
    @Bean AdminAbsoluteSessionLifetimeFilter adminAbsoluteSessionLifetimeFilter(
    ...
    @Bean SecurityFilterChain security(HttpSecurity http,
                                       ...
                                       AdminSecurityProblemHandler problemHandler) throws Exception {
        ...
        return http
            ...
            .authorizeHttpRequests(auth -> auth.requestMatchers("/api/v1/admin/auth/login").permitAll().anyRequest().authenticated())
