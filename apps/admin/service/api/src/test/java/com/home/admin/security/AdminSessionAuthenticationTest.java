...
class AdminSessionAuthenticationTest {
    ...
    void authenticatedViewerCannotUseWritePermission() throws Exception {
        AdminPrincipal viewer = new AdminPrincipal(UUID.randomUUID(), "viewer", "조회자",
            Set.of("VIEWER"), Set.of("COORDINATE_READ"));
    ...
    private AdminPrincipal principal() {
        return new AdminPrincipal(UUID.randomUUID(), "operator", "운영자",
            Set.of("OPERATOR"), Set.of("COORDINATE_READ", "COORDINATE_WRITE"));
    }
    ...
    static class ProbeController {
        ...
        AdminPrincipal get(@AuthenticationPrincipal AdminPrincipal principal) { return principal; }
        ...
        AdminPrincipal post(@AuthenticationPrincipal AdminPrincipal principal) { return principal; }
    }
}
