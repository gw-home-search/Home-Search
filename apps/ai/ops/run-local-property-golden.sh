...
if [[ "$mode" == "offline" ]]; then
    ...
    case "$case_id" in
        complex-identity-jamsil-ells | recent-trades-jamsil-ells-84 | price-trend-jamsil-ells-84 | criteria-recommendation-academy-transit | school-location-jamsil-ells | comparison-jamsil-ells-helio-84 | budget-recommendation-songpa-84-retail) ;;
...
host_property_uri=""
host_reference_uri=""
if [[ "$case_id" == "school-location-jamsil-ells" || "$case_id" == "comparison-jamsil-ells-helio-84" || "$case_id" == "budget-recommendation-songpa-84-retail" ]]; then
...
elif [[ "$case_id" == "school-location-jamsil-ells" || "$case_id" == "comparison-jamsil-ells-helio-84" || "$case_id" == "budget-recommendation-songpa-84-retail" ]]; then
