...
ALTER TABLE region
    ADD COLUMN unit_cnt_sum BIGINT;
...
ALTER TABLE complex
    ADD CONSTRAINT fk_complex_parcel_region
    FOREIGN KEY (parcel_id, region_id)
    REFERENCES parcel (id, region_id)
    ON UPDATE CASCADE;

ALTER TABLE complex
    ADD CONSTRAINT fk_complex_region
    FOREIGN KEY (region_id)
    REFERENCES region (id);

CREATE INDEX ix_complex_region_id ON complex (region_id);
