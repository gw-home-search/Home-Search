...
class JdbcNewsSignalObsidianExportRepositoryTest extends JdbcPostgresTestSupport {

	private final ObjectMapper objectMapper = new ObjectMapper();

	@Test
	@DisplayName("Jdbc news signal obsidian export repository는 first_seen_at KST daily 범위만 조회한다")
	void findsObservedFeaturesWithinFirstSeenDailyRange() {
		seedSourcePolicy();
		...
		NewsSignalObsidianExportRepository repository = new JdbcNewsSignalObsidianExportRepository(
			jdbcClient,
			objectMapper
		);

		assertThat(repository.findObservedBetween(
			OffsetDateTime.parse("2026-06-07T00:00:00+09:00"),
	...
	private Long insertArticleObservation(String sourceKey, String publishedAt, String firstSeenAt) {
		return jdbcClient.sql("""
			...
			VALUES (
			    ...
			    'https://developers.naver.com/docs/serviceapi/search/news/news.md',
			    'Snippet must stay out of markdown export',
