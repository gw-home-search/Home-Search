...
public class InternalAdminCoordinateController {
    ...
    @GetMapping("/pending")
    public List<CoordinatePendingComplex> pending(@RequestParam(defaultValue = "50") int limit,
    ...
    public ResponseEntity<CoordinateOverrideApprovalResult> override(
        ...
        return ResponseEntity.ok(service.approve(pnu, new CoordinateOverrideApprovalCommand(
