...
public class InternalAdminSecurityConfiguration {
    ...
    FilterRegistrationBean<InternalAdminJwtAuthenticationFilter> internalAdminJwtFilter(
        ...
        FilterRegistrationBean<InternalAdminJwtAuthenticationFilter> registration = new FilterRegistrationBean<>(filter);
    ...
    static Map<String, PublicKey> loadPublicKeys(String locations) {
        if (locations == null || locations.isBlank()) throw new IllegalArgumentException("internal admin public keys are required");
        ...
        for (String entry : locations.split(",")) {
            ...
            try {
                ...
                if (Files.size(path) > 16_384) throw new IllegalArgumentException("internal admin public key is too large");
