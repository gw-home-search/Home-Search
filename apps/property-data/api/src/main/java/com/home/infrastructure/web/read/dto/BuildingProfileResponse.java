...
public record BuildingProfileResponse(
    ...
    public static BuildingProfileResponse from(BuildingProfileSummaryResult value) {
        ...
        return new BuildingProfileResponse(
                Ratios.from(value.ratios()),
                Households.from(value.households()),
                Parking.from(value.parking()),
                Building.from(value.building()),
                Elevators.from(value.elevators()),
                Safety.from(value.safety()),
                Dates.from(value.dates()),
                Address.from(value.address()),
                Energy.from(value.energy()));
    }
    ...
    public record Ratios(
        ...
        static Ratios from(BuildingProfileSummaryResult.Ratios v) {
            return v == null
                    ? null
                    : new Ratios(
                            v.scope(),
                            v.quality(),
                            v.buildingCoverageRate(),
                            v.floorAreaRatio(),
                            v.siteAreaM2(),
                            v.buildingAreaM2(),
                            v.totalFloorAreaM2(),
                            v.floorAreaRatioAreaM2());
        }
    }
    ...
    public record Households(
            ...
            Long familyCount,
            Long unitCount) {
        static Households from(BuildingProfileSummaryResult.Households v) {
            return v == null
                    ? null
                    : new Households(v.scope(), v.quality(), v.householdCount(), v.familyCount(), v.unitCount());
        }
    }
    ...
    public record Parking(
        ...
        static Parking from(BuildingProfileSummaryResult.Parking v) {
            return v == null
                    ? null
                    : new Parking(
                            v.scope(),
                            ...
                            v.totalCount(),
                            v.perHousehold(),
                            v.indoorMechanicalCount(),
                            v.indoorMechanicalAreaM2(),
                            v.outdoorMechanicalCount(),
                            v.outdoorMechanicalAreaM2(),
                            v.indoorAutomaticCount(),
                            v.indoorAutomaticAreaM2(),
                            v.outdoorAutomaticCount(),
    ...
    public record Building(
        ...
        static Building from(BuildingProfileSummaryResult.Building v) {
            return v == null
                    ? null
                    : new Building(
                            v.scope(),
                            v.quality(),
                            v.mainBuildingCount(),
                            v.attachedBuildingCount(),
                            v.maxGroundFloorCount(),
                            v.maxUndergroundFloorCount(),
                            v.maxHeightM(),
                            v.structures(),
                            v.roofs(),
                            v.primaryUses());
    ...
    public record Elevators(
        ...
        static Elevators from(BuildingProfileSummaryResult.Elevators v) {
            return v == null ? null : new Elevators(v.scope(), v.quality(), v.rideUseCount(), v.emergencyUseCount());
        }
    }
    ...
    public record Safety(
        ...
        static Safety from(BuildingProfileSummaryResult.Safety v) {
            return v == null ? null : new Safety(v.scope(), v.quality(), v.seismicDesignStatus(), v.seismicAbilities());
        }
    }
    ...
    public record Dates(
        ...
        static Dates from(BuildingProfileSummaryResult.Dates v) {
            return v == null
                    ? null
                    : new Dates(v.scope(), v.quality(), v.permitDate(), v.constructionStartDate(), v.useApprovalDate());
        }
    }
    ...
    public record Address(
            ...
            String roadAddress) {
        static Address from(BuildingProfileSummaryResult.Address v) {
            return v == null ? null : new Address(v.scope(), v.quality(), v.parcelAddress(), v.roadAddress());
        }
    }
    ...
    public record Energy(
        ...
        static Energy from(BuildingProfileSummaryResult.Energy v) {
            return v == null
                    ? null
                    : new Energy(
                            v.scope(),
                            ...
                            v.greenScoreMax(),
                            v.intelligentGrades(),
                            v.intelligentScoreMin(),
                            v.intelligentScoreMax());
        }
    }
}
