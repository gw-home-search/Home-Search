...
class OdcMetadataGapFillTasklet implements Tasklet {
	...
	OdcMetadataGapFillTasklet(OdcMetadataGapFillService service, BuildingMetadataExecutionLock executionLock,
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
		...
		try (BuildingMetadataExecutionLock.Lock ignored = executionLock.acquire()) {
			service.fill(maxTargets, optionalLong(params.get("fromComplexId")),
