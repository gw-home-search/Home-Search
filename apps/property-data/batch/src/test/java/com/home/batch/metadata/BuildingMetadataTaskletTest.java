...
class BuildingMetadataTaskletTest {
    ...
    void executesCollectionWithinQuota() throws Exception {
        ...
        ChunkContext context = context(Map.of(
                "mode",
                "missing",
                "maxRequests",
                "900",
    ...
    void rejectsCollectionOverQuota() {
        BuildingMetadataCollectTasklet tasklet = new BuildingMetadataCollectTasklet(
                mock(BuildingMetadataBatchService.class), mock(BuildingMetadataExecutionLock.class), 1000);
