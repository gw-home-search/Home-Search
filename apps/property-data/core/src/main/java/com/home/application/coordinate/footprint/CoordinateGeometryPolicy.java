...
public class CoordinateGeometryPolicy {
    ...
    public Optional<CoordinateCenter> parcelCenter(String expectedPnu, List<CoordinateFeatureCandidate> features) {
        ...
        return Optional.of(new CoordinateCenter(center(minLatitude, maxLatitude), center(minLongitude, maxLongitude)));
    }
    ...
    private Optional<BuildingFootprintImportCandidate> footprint(
            String expectedPnu, String source, String snapshotVersion, BuildingFootprintFeatureCandidate feature) {
    ...
    private record Bbox(
            BigDecimal minLongitude, BigDecimal minLatitude, BigDecimal maxLongitude, BigDecimal maxLatitude) {}
}
