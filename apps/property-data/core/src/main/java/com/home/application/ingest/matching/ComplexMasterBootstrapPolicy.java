...
public class ComplexMasterBootstrapPolicy {
    ...
    public Optional<ComplexMasterBootstrapResult> validateExistingAptSeqCandidateCount(
            String aptSeq, int existingComplexCount) {
        if (existingComplexCount > 1) {
            return Optional.of(
                    ComplexMasterBootstrapResult.skipped("master bootstrap skipped: ambiguous aptSeq=" + aptSeq));
        }
        return Optional.empty();
    }

    public Optional<ComplexMasterBootstrapResult> validateExistingAptSeqPnu(
            String aptSeq, Optional<String> pnu, Optional<String> complexPnu) {
        if (pnu.isEmpty()) {
            return Optional.of(
                    ComplexMasterBootstrapResult.skipped("master bootstrap skipped: pnu unavailable aptSeq=" + aptSeq));
        }
    ...
    public Optional<ComplexMasterBootstrapResult> validateNewInput(
            String aptSeq, String aptName, Optional<String> pnu) {
    ...
    public Optional<ComplexMasterBootstrapResult> validateExistingComplexPkPnu(
            String complexPk, String pnu, Optional<String> complexPnu) {
        if (complexPnu.isEmpty()) {
            return Optional.of(ComplexMasterBootstrapResult.skipped(
    ...
    public Optional<ComplexMasterBootstrapResult> validateParcel(String pnu, Optional<Long> parcelId) {
        if (parcelId.isEmpty()) {
            return Optional.of(
                    ComplexMasterBootstrapResult.skipped("master bootstrap skipped: parcel unavailable pnu=" + pnu));
        }
        return Optional.empty();
    }
