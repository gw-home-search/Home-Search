...
public record TradeMatchEvidenceCommand(
    ...
    public static TradeMatchEvidenceCommand from(
            Long rawIngestId, String source, OpenApiTradeItem item, ComplexMatchResult match) {
        RtmsJibunPnu pnu =
                match == null || match.jibunPnu() == null ? RtmsJibunPnuNormalizer.normalize(item) : match.jibunPnu();
