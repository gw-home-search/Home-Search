...
public record RtmsIngestRunReportQuery(
        String lawdCd, String dealYmdFrom, String dealYmdTo, List<RtmsIngestRunStatus> statuses, int recentRunLimit) {
    ...
    public static RtmsIngestRunReportQuery between(String lawdCd, String dealYmdFrom, String dealYmdTo) {
        return new RtmsIngestRunReportQuery(
                lawdCd, dealYmdFrom, dealYmdTo, RtmsIngestRunStatus.all(), DEFAULT_RECENT_RUN_LIMIT);
    }
