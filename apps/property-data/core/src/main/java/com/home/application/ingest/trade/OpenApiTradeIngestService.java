...
public class OpenApiTradeIngestService {
    ...
    public OpenApiTradeIngestService(TradeIngestItemProcessor itemProcessor, TradeIngestMetrics tradeIngestMetrics) {
    ...
    public IngestResult ingest(OpenApiTradeIngestBatch batch, ExecutionCorrelationId executionCorrelationId) {
        ...
        IngestResult result =
                accumulator.toResult(batch.items().size(), batch.items().size());
