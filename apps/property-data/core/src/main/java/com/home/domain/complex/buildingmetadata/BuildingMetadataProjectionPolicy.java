...
public final class BuildingMetadataProjectionPolicy {
	...
	public ProjectionDecision decide(BuildingMetadataValues current, BuildingMetadataValues candidate) {
		...
		BuildingMetadataValues safeCandidate = candidate == null ? BuildingMetadataValues.empty() : candidate.sanitized();
	...
	private <T> T first(T left, T right) { return left != null ? left : right; }
