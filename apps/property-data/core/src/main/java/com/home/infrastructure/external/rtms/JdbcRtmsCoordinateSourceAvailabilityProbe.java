...
class JdbcRtmsCoordinateSourceAvailabilityProbe implements RtmsCoordinateSourceAvailabilityProbe {
    ...
    JdbcRtmsCoordinateSourceAvailabilityProbe(
        ...
        dataSource.setConnectionProperties(connectionProperties(
                connectTimeoutSeconds, socketTimeoutSeconds, lockTimeoutMillis, statementTimeoutMillis));
    ...
    private Properties connectionProperties(
            int connectTimeoutSeconds, int socketTimeoutSeconds, int lockTimeoutMillis, int statementTimeoutMillis) {
