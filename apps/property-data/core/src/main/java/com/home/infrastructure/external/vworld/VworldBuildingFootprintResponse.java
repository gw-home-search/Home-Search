...
record VworldBuildingFootprintResponse(Integer totalCount, Integer totalFeatures, List<Feature> features) {
    ...
    List<BuildingFootprintImportCandidate> footprints(String expectedPnu, String source, String snapshotVersion) {
        return GEOMETRY_POLICY.footprints(
                expectedPnu,
                source,
                snapshotVersion,
                features == null
                        ? List.of()
                        : features.stream().map(Feature::candidate).toList());
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    record Feature(String id, List<BigDecimal> bbox, Properties properties) {
    ...
    record Properties(
            ...
            @com.fasterxml.jackson.annotation.JsonProperty("buld_nm")
            String buldNm,

            @com.fasterxml.jackson.annotation.JsonProperty("dong_nm")
            String dongNm,

            @com.fasterxml.jackson.annotation.JsonProperty("gis_idntfc_no")
            String gisIdntfcNo,

            @com.fasterxml.jackson.annotation.JsonProperty("refrn_systm_cntc_no")
            String refrnSystmCntcNo) {}
}
