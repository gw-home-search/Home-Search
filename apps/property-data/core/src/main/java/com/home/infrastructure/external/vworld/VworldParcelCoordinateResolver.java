...
public class VworldParcelCoordinateResolver implements ParcelCoordinateResolver {
    ...
    public VworldParcelCoordinateResolver(RestClient restClient, VworldParcelCoordinateProperties properties) {
    ...
    public Optional<ParcelCoordinate> resolve(String pnu) {
        ...
        try {
            ...
            VworldParcelCoordinateResponse response = restClient
                    .get()
