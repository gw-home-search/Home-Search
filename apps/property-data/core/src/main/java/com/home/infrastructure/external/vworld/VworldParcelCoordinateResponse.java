...
public record VworldParcelCoordinateResponse(List<Feature> features) {
    ...
    Optional<CoordinateCenter> center(String pnu) {
        return GEOMETRY_POLICY.parcelCenter(
                pnu,
                features == null
                        ? List.of()
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    record Feature(List<BigDecimal> bbox, Properties properties) {
