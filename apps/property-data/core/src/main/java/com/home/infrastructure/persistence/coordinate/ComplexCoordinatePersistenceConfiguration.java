...
class ComplexCoordinatePersistenceConfiguration {
    ...
    @Bean
    @Lazy
    CoordinateResolutionCommitter coordinateResolutionCommitter(ComplexCoordinateExceptionRepository repository) {
    ...
    @Bean
    @Lazy
    CoordinateOverrideAdminService coordinateOverrideAdminService(CoordinateOverrideAdminRepository repository) {
    ...
    ApplicationRunner complexCoordinateReadinessRunner(
        ...
        return new ComplexCoordinateReadinessRunner(
                complexCoordinateReadinessService, stageLimit, resolveLimit, projectLimit);
    }
    ...
    private PlatformTransactionManager requiredTransactionManager(
        ...
        return transactionManagerProvider.getIfAvailable(() -> {
            throw new IllegalStateException(
                    "PlatformTransactionManager is required for complex coordinate persistence");
        });
    }
}
