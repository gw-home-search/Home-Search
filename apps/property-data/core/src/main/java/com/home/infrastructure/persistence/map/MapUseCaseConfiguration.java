...
class MapUseCaseConfiguration {
    ...
    MapUseCase mapUseCase(
        ...
        return new MapQueryUseCase(complexMarkerRepository, new JdbcRegionMarkerRepository(jdbcClient));
    }
    ...
    private ComplexMarkerRepository complexMarkerRepository(
        ...
        return new RedisCachingComplexMarkerRepository(
                repository, redisTemplate, objectMapper, markerCacheTtl, meterRegistry);
    }
