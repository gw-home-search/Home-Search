...
class ComplexCoordinateExceptionServiceTest {
    ...
    void stagesOnlyConcurrentOrUnknownMultiComplexParcels() {
        ...
        repository.caseCandidates =
                List.of(new ComplexCoordinateCaseCandidate(1001L), new ComplexCoordinateCaseCandidate(1002L));
    ...
    void resolvesDisplayCoordinatesWhenAptDongMatchesSingleBuildingCandidate() {
        ...
        repository.footprints = Map.of(
                "1168010300101400001",
                List.of(
                        new BuildingFootprintCandidate(
                                9001L, "1168010300101400001", "Tower A", "101동", bd("37.5010000"), bd("127.0010000")),
                        new BuildingFootprintCandidate(
                                9002L, "1168010300101400001", "Tower B", "201동", bd("37.5020000"), bd("127.0020000"))));
    ...
    void aggregatesMultipleBuildingFootprintsForOneComplex() {
        ...
        repository.targets = Map.of(
                ...
                new ComplexCoordinateParcelTargets(
                        ...
                        "4128510200115660000",
                        List.of(
                                new ComplexCoordinateTarget(
                                        1590L, "41285-15", "중산마을10(동신)", Set.of("1001", "1002", "1003")),
                                new ComplexCoordinateTarget(1628L, "41285-12", "중산마을10(경남)", Set.of("1006", "1008")))));
        repository.footprints = Map.of(
                "4128510200115660000",
                List.of(
                        new BuildingFootprintCandidate(
                                9001L, "4128510200115660000", "중산마을", "1001동", bd("37.6875000"), bd("126.7780000")),
                        new BuildingFootprintCandidate(
                                9002L, "4128510200115660000", "중산마을", "1002동", bd("37.6880000"), bd("126.7783000")),
                        new BuildingFootprintCandidate(
                                9003L, "4128510200115660000", "중산마을", "1003동", bd("37.6885000"), bd("126.7786000")),
                        new BuildingFootprintCandidate(
                                9006L, "4128510200115660000", "중산마을", "1006동", bd("37.6890000"), bd("126.7779000")),
                        new BuildingFootprintCandidate(
                                9008L, "4128510200115660000", "중산마을", "1008동", bd("37.6896000"), bd("126.7781000"))));
        ComplexCoordinateExceptionService service = service(repository);
    ...
    void keepsAmbiguousWhenBuildingFootprintMatchesMultipleComplexes() {
        ...
        assertThat(repository.caseUpdates)
                ...
                .containsExactly(org.assertj.core.groups.Tuple.tuple(
                        ComplexCoordinateCaseStatus.AMBIGUOUS, "building dong candidates overlap across complexes"));
    }
    ...
    void fetchesVworldFootprintsWhenSamePnuCandidateHasNoStoredFootprints() {
        ...
        ComplexCoordinateExceptionService service =
                service(repository, ComplexCoordinateIdentityVerifier.trusting(), footprintSource);
    ...
    void blocksCoordinateResolutionWhenOdcloudIdentityIsAmbiguous() {
        ...
        repository.footprints = Map.of(
                "1168010300101400001",
                List.of(new BuildingFootprintCandidate(
                        9001L, "1168010300101400001", "Tower A", "101동", bd("37.5010000"), bd("127.0010000"))));
        ComplexCoordinateExceptionService service = service(
                repository,
                (parcelTargets, target) ->
                        ComplexCoordinateIdentityVerification.ambiguous("ODC has multiple PNU candidates"));
    ...
    void degradesToResolutionWhenOdcloudIdentityIsUnavailable() {
        ...
        ComplexCoordinateExceptionService service = service(
                repository,
                (parcelTargets, target) ->
                        ComplexCoordinateIdentityVerification.unavailable("ODC identity candidate unavailable"));
    ...
    private static BuildingFootprintImportCandidate importFootprint(
            String pnu, String dongName, String latitude, String longitude) {
    ...
    private static ComplexCoordinateExceptionService service(
            InMemoryCoordinateRepository repository, ComplexRelationRepository relationRepository) {
        return service(
                repository,
                relationRepository,
    ...
    private static ComplexCoordinateExceptionService service(
            InMemoryCoordinateRepository repository, ComplexCoordinateIdentityVerifier identityVerifier) {
    ...
    private static ComplexCoordinateExceptionService service(
        ...
        return service(
                repository, parcelId -> List.of(), identityVerifier, buildingFootprintSource, identityBlockingPolicy);
    }
    ...
    private static final class InMemoryCoordinateRepository implements ComplexCoordinateExceptionRepository {
        ...
        public void saveBuildingFootprints(List<BuildingFootprintImportCandidate> footprints) {
            ...
            for (BuildingFootprintImportCandidate footprint : footprints) {
                List<BuildingFootprintCandidate> existing =
                        new ArrayList<>(mutable.getOrDefault(footprint.pnu(), List.of()));
