...
class CoordinateGeometryPolicyTest {
    ...
    void acceptsBlankFeaturePnuAsNonConflictingParcelFeature() {
        var center =
                policy.parcelCenter("1168010300107770001", List.of(feature(null, "127.0", "37.0", "127.2", "37.2")));
    ...
    private CoordinateFeatureCandidate feature(
            String pnu, String minLongitude, String minLatitude, String maxLongitude, String maxLatitude) {
        return new CoordinateFeatureCandidate(pnu, bbox(minLongitude, minLatitude, maxLongitude, maxLatitude));
    }

    private List<BigDecimal> bbox(String minLongitude, String minLatitude, String maxLongitude, String maxLatitude) {
        return List.of(
