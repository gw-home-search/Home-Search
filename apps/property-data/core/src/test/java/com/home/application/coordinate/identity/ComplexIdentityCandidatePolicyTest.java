...
class ComplexIdentityCandidatePolicyTest {
    ...
    void confirmsExactAptSeqAndParcelPnuMatch() {
        ComplexCoordinateIdentityVerification verification = policy.verify(
                "11530-4350", "1153011200102380000", List.of(candidate("11530-4350", "1153011200102380000")));
    ...
    void returnsUnavailableWhenCandidatesAreEmpty() {
        ComplexCoordinateIdentityVerification verification =
                policy.verify("11530-4350", "1153011200102380000", List.of());
    ...
    void returnsUnavailableWhenExactCandidateHasNoValidPnu() {
        ...
        ComplexCoordinateIdentityVerification verification =
                policy.verify("11530-4350", "1153011200102380000", candidates);
    ...
    void returnsAmbiguousWhenExactCandidateHasMultipleDistinctPnus() {
        List<ComplexIdentityCandidate> candidates =
                List.of(candidate("11530-4350", "1153011200102380000"), candidate("11530-4350", "1153011200102390000"));
    ...
    void returnsAmbiguousWhenOdcloudPnuConflictsWithParcelPnu() {
        ComplexCoordinateIdentityVerification verification = policy.verify(
                "11530-4350", "1153011200102380000", List.of(candidate("11530-4350", "1153011200102390000")));
    ...
    void resolvesOnlySingleExactValidPnu() {
        assertThat(policy.resolveUniquePnu("11530-4350", List.of(candidate("11530-4350", "1153011200102380000"))))
        ...
        assertThat(policy.resolveUniquePnu(
                ...
                .isEmpty();
        assertThat(policy.resolveUniquePnu("11530-4350", List.of(candidate("11530-4350", "invalid"))))
                .isEmpty();
    }
