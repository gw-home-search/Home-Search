...
class ComplexMatchCandidatePolicyTest {
    ...
    void confirmsUniqueAptSeqCandidateWhenPnuMatches() {
        ComplexMatchResult result = policy.match(
                ...
                List.of(candidate(
                        501L, "COMPLEX-PK-501", "Sample Apartment", "Sample Apartment", "1168010300101400001")),
                List.of());
    ...
    void rejectsUniqueAptSeqCandidateWhenPnuConflicts() {
        ComplexMatchResult result = policy.match(
                ...
                List.of(candidate(
                        501L, "COMPLEX-PK-501", "Sample Apartment", "Sample Apartment", "1168010300101400001")),
                List.of(candidate(
                        502L, "COMPLEX-PK-502", "Other Apartment", "Other Apartment", "1168010300109990001")));
        ...
        ComplexMatchResult result = policy.match(
                ...
                List.of(
                        candidate(
                                501L, "COMPLEX-PK-501", "Sample Apartment", "Sample Apartment", "1168010300101400001"),
                        candidate(
                                502L, "COMPLEX-PK-502", "Sample Apartment", "Sample Apartment", "1168010300101400001")),
                List.of());
    ...
    void returnsUnavailableWhenPnuCannotBeDerived() {
        ComplexMatchResult result =
                policy.match(null, "Sample Apartment", unavailablePnu("invalid jibun"), List.of(), List.of());
    ...
    void returnsUnmatchedWhenPnuHasNoCandidate() {
        ComplexMatchResult result =
                policy.match("APT-404", "Missing Apartment", availablePnu("1168010300109990001"), List.of(), List.of());
    ...
    private ComplexMatchCandidate candidate(
            Long complexId, String complexPk, String tradeName, String name, String parcelPnu) {
