...
class OdcMetadataGapFillServiceTest {
    ...
    private static final ComplexMetadataLookup LOOKUP =
            new ComplexMetadataLookup(501L, "APT-501", "Sample", "1168010300101400001", "Sample address", 0);
    ...
    void sharedPnuIsRecordedWithoutExternalCall() {
        ...
        OdcMetadataGapFillSummary summary =
                new OdcMetadataGapFillService(repository, resolver).fill(20, null, 1000L, REQUEST_ID);
    ...
    void resolvesSinglePnuThroughOdcOnly() {
        ...
        ComplexMetadataResolution resolution = ComplexMetadataResolution.partial(
                "ODC", new ComplexMetadata(8, null, null, null, null, null, null, null));
        given(resolver.isOdcConfigured()).willReturn(true);
        ...
        given(repository.saveResolution(target, resolution, REQUEST_ID))
                .willReturn(OdcMetadataGapFillOutcome.applied());

        OdcMetadataGapFillSummary summary =
                new OdcMetadataGapFillService(repository, resolver).fill(20, 500L, 1000L, REQUEST_ID);
