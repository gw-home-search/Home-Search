...
class MapQueryUseCaseTest {
    ...
    private final ComplexMarkerQuery complexRequest =
            new ComplexMarkerQuery(37.45, 126.85, 37.70, 127.20, null, null, null, null, null, null, null, null);
    private final RegionMarkerQuery regionRequest = new RegionMarkerQuery(37.45, 126.85, 37.70, 127.20, "si-gun-gu");
