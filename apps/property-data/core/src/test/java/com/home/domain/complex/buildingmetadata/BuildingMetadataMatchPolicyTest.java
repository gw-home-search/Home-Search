...
class BuildingMetadataMatchPolicyTest {
    ...
    void usesApprovedOdcIdentityWithoutComparingAptSeq() {
        var result = policy.resolveOdc(
                PNU,
                List.of(internal(501, "내부 이름")),
                List.of(new SourceCandidate("987654321", PNU, List.of("다른 이름"), BuildingMetadataValues.empty(), 501L)));
    ...
    void resolvesOnlyExactMutualNameAndRejectsTie() {
        var exact = policy.resolveOdc(
                PNU,
                List.of(internal(501, "래미안 1차"), internal(502, "래미안 2차")),
                List.of(new SourceCandidate("odc-1", PNU, List.of("래미안(1차)"), BuildingMetadataValues.empty(), null)));
        var partial = policy.resolveOdc(
                PNU,
                List.of(internal(501, "래미안 1차 아파트")),
                List.of(new SourceCandidate("odc-2", PNU, List.of("래미안"), BuildingMetadataValues.empty(), null)));
        var tie = policy.resolveOdc(
                PNU,
                List.of(internal(501, "동일 이름"), internal(502, "동일 이름")),
                List.of(new SourceCandidate("odc-3", PNU, List.of("동일 이름"), BuildingMetadataValues.empty(), null)));
    ...
    void handlesBlankBuildingNameAndAuxiliaryConflict() {
        var blankSingle = policy.resolveBuilding(
                PNU,
                List.of(internal(501, "래미안")),
                List.of(new SourceCandidate("bld-1", PNU, List.of(""), BuildingMetadataValues.empty(), null)));
        var blankMultiple = policy.resolveBuilding(
                PNU,
                List.of(internal(501, "래미안"), internal(502, "자이")),
                List.of(new SourceCandidate("bld-2", PNU, List.of(""), BuildingMetadataValues.empty(), null)));
        BuildingMetadataValues conflicting =
                new BuildingMetadataValues(8, 741, null, null, null, null, null, LocalDate.of(2015, 3, 20));
        var valueConflict = policy.resolveBuilding(
                PNU,
                List.of(
