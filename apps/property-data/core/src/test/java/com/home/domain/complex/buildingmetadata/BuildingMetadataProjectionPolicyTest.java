...
class BuildingMetadataProjectionPolicyTest {
    ...
    void sanitizesInvalidValuesAndFillsOnlyMissingValues() {
        ...
        BuildingMetadataValues candidate = new BuildingMetadataValues(
                8, 740, new BigDecimal("123.45"), BigDecimal.ZERO, new BigDecimal("-1"), null, null, null);
    ...
    void holdsAllProjectionChangesOnAnyConflict() {
        BuildingMetadataValues current = new BuildingMetadataValues(8, 740, null, null, null, null, null, null);
        BuildingMetadataValues candidate =
                new BuildingMetadataValues(8, 741, new BigDecimal("123.45"), null, null, null, null, null);
