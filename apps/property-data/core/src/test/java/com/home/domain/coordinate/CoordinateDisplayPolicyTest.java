...
class CoordinateDisplayPolicyTest {
    ...
    void classifiesTrustedBuildingFootprintConfidence() {
        assertThat(CoordinateDisplayPolicy.TRUSTED_BUILDING_FOOTPRINT_CONFIDENCE)
                .isEqualTo(80);
        assertThat(CoordinateDisplayPolicy.isTrustedBuildingFootprintConfidence(79))
                .isFalse();
        assertThat(CoordinateDisplayPolicy.isTrustedBuildingFootprintConfidence(80))
                .isTrue();
        assertThat(CoordinateDisplayPolicy.isTrustedBuildingFootprintConfidence(90))
                .isTrue();
    }
    ...
    void keepsStoredCoordinateSourceValues() {
        ...
        assertThat(CoordinateSource.BUILDING_FOOTPRINT.matches("BUILDING_FOOTPRINT"))
                .isTrue();
        assertThat(CoordinateSource.BUILDING_FOOTPRINT.matches("PARCEL_FALLBACK"))
                .isFalse();
    }
}
