...
class VworldExternalApiConfigurationTest {
    ...
    void primaryCoordinateResolverDoesNotCallVworldFallbackOnCoordinateSourceMiss() {
        ...
        ParcelCoordinateResolver resolver =
                configuration.parcelCoordinateResolver(pnu -> Optional.empty(), pnu -> Optional.empty());
    ...
    void primaryCoordinateResolverUsesApprovedOverrideWithoutVworldFallback() {
        VworldExternalApiConfiguration configuration = new VworldExternalApiConfiguration();
        ParcelCoordinate override =
                new ParcelCoordinate(new java.math.BigDecimal("37.6012345"), new java.math.BigDecimal("127.1543210"));
        ParcelCoordinateResolver resolver =
                configuration.parcelCoordinateResolver(pnu -> Optional.empty(), pnu -> Optional.of(override));
