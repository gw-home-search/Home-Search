...
class ComplexCoordinateReadinessRunnerTest {
    ...
    void runnerRunsAfterRawIngestReconciliation() {
        ComplexCoordinateReadinessRunner runner =
                new ComplexCoordinateReadinessRunner(new FakeReadinessService(), 3, 5, 7);
    ...
    private static final class NoopProjectionRepository
            implements com.home.application.coordinate.display.ComplexDisplayCoordinateProjectionRepository {

        @Override
        public List<com.home.application.coordinate.display.ComplexDisplayCoordinateProjectionTarget>
                findProjectionTargets(int limit) {
            return List.of();
        }

        @Override
        public void saveDisplayCoordinate(
                com.home.application.coordinate.display.ComplexDisplayCoordinateCommand command) {}
    }

    private static final class NoopCoordinateExceptionRepository
            implements com.home.application.coordinate.caseflow.ComplexCoordinateExceptionRepository {

        @Override
        public List<com.home.application.coordinate.caseflow.ComplexCoordinateCaseCandidate>
                findExceptionCaseCandidates(int limit) {
            return List.of();
        }
        ...
        @Override
        public java.util.Optional<com.home.application.coordinate.identity.ComplexCoordinateParcelTargets>
                findParcelTargets(Long parcelId) {
            return java.util.Optional.empty();
        }

        @Override
        public List<com.home.application.coordinate.footprint.BuildingFootprintCandidate> findBuildingFootprintsByPnu(
                String pnu) {
            return List.of();
        }
        ...
        @Override
        public void saveResolvedDisplayCoordinate(
                com.home.application.coordinate.display.ResolvedDisplayCoordinate coordinate) {}
    }
}
