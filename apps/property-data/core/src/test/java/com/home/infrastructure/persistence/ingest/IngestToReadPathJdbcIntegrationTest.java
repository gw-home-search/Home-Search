...
class IngestToReadPathJdbcIntegrationTest extends JdbcPostgresTestSupport {
    ...
    void ingestedNormalizedTradesBackMapDetailAndTradeReadPaths() {
        ...
        assertThat(detailReader.findParcelDetail(1001L, null)).hasValueSatisfying(detail -> {
        ...
        assertThat(searchReader.searchComplexes("sample")).singleElement().satisfies(resultRow -> {
    ...
    void canceledIngestedTradeIsExcludedFromMapAndTradeReadPaths() {
        ...
        IngestResult inserted = ingestService.ingest(new OpenApiTradeIngestBatch(
                ...
                "202512",
                1,
                List.of(rtmsItem("APT-501", "Sample Apartment", 1, "125,000", 12, "140-1", "101"), active)));
        IngestResult deleted =
                ingestService.ingest(new OpenApiTradeIngestBatch("RTMS", "11680", "202512", 1, List.of(canceled)));
        ...
        assertThat(tradeReader.findTradeList(1001L, null, 0, 25))
                .hasValueSatisfying(tradeList ->
                        assertThat(tradeList.trades()).extracting("dealAmount").containsExactly(125000L));
    }
    ...
    private OpenApiTradeItem rtmsItem(
            String aptSeq, String aptName, int dealDay, String dealAmount, int floor, String jibun, String aptDong) {
