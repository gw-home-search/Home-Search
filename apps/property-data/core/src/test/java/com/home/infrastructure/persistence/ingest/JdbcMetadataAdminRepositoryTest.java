...
class JdbcMetadataAdminRepositoryTest extends JdbcPostgresTestSupport {
    ...
    void holdsAndRetriesWithAuditHistory() {
        ...
        assertThat(repository.hold(501L, "operator", "source conflict").updated())
                .isTrue();
        ...
        assertThat(repository.retry(501L, "operator", "source updated").updated())
                .isTrue();
        ...
        assertThat(detail.decisions())
                .extracting(decision -> decision.decisionType())
    ...
    void proposesAndApprovesAliasWithAuditHistory() {
        ...
        assertThat(repository
                        .approveAlias(proposed.id(), "reviewer", "verified")
                        .updated())
                .isTrue();
        assertThat(repository.aliases())
                .filteredOn(alias -> alias.id() == proposed.id())
                .singleElement()
                .satisfies(alias -> {
    ...
    private void seedMetadataComplex() {
        jdbcClient
                .sql("INSERT INTO region(id,code,name,region_type) VALUES(1,'1168010300','Sample','eup-myeon-dong')")
                .update();
        jdbcClient.sql("""
