...
class RedisCachingComplexMarkerRepositoryTest {
    ...
    void cacheHitSkipsDelegateLookup() {
        ...
        var repository = new RedisCachingComplexMarkerRepository(
                delegate, redisTemplateBackedBy(new HashMap<>()), objectMapper, CACHE_TTL, new SimpleMeterRegistry());
    ...
    void redisFailureFallsBackToDelegateLookup() {
        ...
        var repository = new RedisCachingComplexMarkerRepository(
                delegate, redisTemplate, objectMapper, CACHE_TTL, new SimpleMeterRegistry());
    ...
    void recordsCacheResultMetrics() {
        ...
        var repository = new RedisCachingComplexMarkerRepository(
                healthyDelegate, redisTemplateBackedBy(new HashMap<>()), objectMapper, CACHE_TTL, meterRegistry);
        ...
        var fallbackRepository = new RedisCachingComplexMarkerRepository(
                fallbackDelegate, brokenRedisTemplate, objectMapper, CACHE_TTL, meterRegistry);
        fallbackRepository.findComplexMarkers(seedWideRequest());

        assertThat(meterRegistry
                        .counter(CACHE_METRIC_NAME, "endpoint", "complexes", "result", "miss")
                        .count())
                .isEqualTo(1);
        assertThat(meterRegistry
                        .counter(CACHE_METRIC_NAME, "endpoint", "complexes", "result", "hit")
                        .count())
                .isEqualTo(1);
        assertThat(meterRegistry
                        .counter(CACHE_METRIC_NAME, "endpoint", "complexes", "result", "fallback")
                        .count())
                .isEqualTo(1);
    }
    ...
    void recordsFallbackMetricWhenCacheWriteFails() {
        ...
        var repository = new RedisCachingComplexMarkerRepository(
                delegate, redisTemplate, objectMapper, CACHE_TTL, meterRegistry);
    ...
    private static ComplexMarkerQuery seedWideRequest() {
        return request(37.45, 126.85, 37.70, 127.20, null, null, null, null, null, null, null, null);
    }

    private static ComplexMarkerQuery unitFilterRequest() {
        return request(37.45, 126.85, 37.70, 127.20, null, null, null, null, null, null, 100L, 2000L);
    }
