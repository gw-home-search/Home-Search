...
"${SERVICE_ROOT}/ops/property-deployment-preflight.sh" before 10
"${SERVICE_ROOT}/ops/property-flyway.sh" migrate 10 >/dev/null
"${SERVICE_ROOT}/ops/property-deployment-preflight.sh" after 10
...
if [[ "${installed_versions}" != '1,2,4,5,6,7,8,9,10' ]]; then
