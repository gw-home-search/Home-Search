...
"${SERVICE_ROOT}/ops/property-deployment-preflight.sh" before 12
"${SERVICE_ROOT}/ops/property-flyway.sh" migrate 12 >/dev/null
"${SERVICE_ROOT}/ops/property-deployment-preflight.sh" after 12
...
if [[ "${installed_versions}" != '1,2,4,5,6,7,8,9,10,11,12' ]]; then
