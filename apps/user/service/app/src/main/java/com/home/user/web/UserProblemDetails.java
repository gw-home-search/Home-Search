...
public final class UserProblemDetails {
    ...
    public static ProblemDetail create(
            HttpStatus status, String title, String detailMessage, String code, String exception) {
    ...
    public static void write(
            HttpServletResponse response, HttpStatus status, String title, String detail, String code, String exception)
            throws IOException {
