...
public class FavoriteComplexId implements Serializable {
    ...
    public FavoriteComplexId(long userId, long complexId) {
        this.userId = userId;
    ...
    public boolean equals(Object other) {
        return other instanceof FavoriteComplexId id
                && Objects.equals(userId, id.userId)
                && Objects.equals(complexId, id.complexId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(userId, complexId);
    }
}
