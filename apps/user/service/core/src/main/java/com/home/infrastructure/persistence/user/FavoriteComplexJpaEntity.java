...
public class FavoriteComplexJpaEntity {
    @EmbeddedId private FavoriteComplexId id;
    @Column(name = "saved_at", nullable = false, updatable = false) private Instant savedAt;
    ...
    public long userId() { return id.userId(); }
    public long complexId() { return id.complexId(); }
