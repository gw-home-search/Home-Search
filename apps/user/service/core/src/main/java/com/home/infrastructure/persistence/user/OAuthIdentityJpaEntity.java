...
@Entity @Table(schema="users",name="oauth_identity")
public class OAuthIdentityJpaEntity{
 ...
 public OAuthIdentityJpaEntity(long userId,String provider,String subject,Instant now){this.userId=userId;this.provider=provider;this.providerSubject=subject;this.createdAt=now;this.lastLoginAt=now;}
 public void loginAt(Instant now){this.lastLoginAt=now;}public long userId(){return userId;}public String provider(){return provider;}
}
