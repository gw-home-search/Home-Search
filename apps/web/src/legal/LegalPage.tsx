  ...
  return (
    <main className="legal-document">
      ...
      <ul>
        ...
        <li>서비스 분석: 기기·브라우저 정보, 접속 페이지, 이용 상호작용, 동의 상태와 선택적 쿠키·온라인 식별자 — 이용 현황 분석과 품질 개선</li>
      </ul>
      <h2>2. 보유 및 파기</h2>
      <p>회원 탈퇴 시 개인정보를 지체 없이 삭제합니다. 관계 법령에 보존 의무가 있는 정보는 다른 정보와 분리해 법정 기간 동안만 보관한 뒤 삭제합니다.</p>
      <h2>3. Google Analytics</h2>
      <p>Google Analytics 태그는 방문 시 로드됩니다. 분석 쿠키를 거부하면 해당 쿠키를 저장하거나 읽지 않지만, 동의 상태와 쿠키 없는 제한적인 방문 신호가 Google LLC의 분석 서비스로 네트워크를 통해 이전되어 이용 통계 작성에 사용될 수 있습니다. 분석 쿠키에 동의하면 쿠키와 온라인 식별자를 사용하는 일반 분석이 활성화됩니다. 이용자는 화면 하단의 쿠키 설정에서 언제든 허용 또는 거부를 다시 선택할 수 있습니다.</p>
      <h2>4. 이용자의 권리</h2>
