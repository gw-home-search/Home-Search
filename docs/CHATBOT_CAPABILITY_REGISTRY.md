...
| `recommendation` | “영등포구 500세대 이상, 학원 우선 후보” | 제한 지원 | 부동산 A, Sbiz 학원 B, 철도 A, 학교 A, 좌표 확인 대규모점포 A | A | 기존 결정형 정책 또는 bounded 후보 안의 AI 선택, 검증된 강점·tradeoff | 후보군 밖 선택, 절대평가, 수익 보장, LLM 임의 수치·점수 | 사용한 모든 필수 dataset 통과 | 비활성 조건과 후보 0건 이유 설명 |
