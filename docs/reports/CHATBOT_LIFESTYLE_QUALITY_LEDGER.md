...
잔여 위험: runtime exact allowlist의 comparison·recommendation·hospital map action 활성화는 별도 activation commit과 live readiness evidence가 필요; childcare lookup/YOUNG_CHILD는 provider 승인·전국 coverage 확인 전 활성화 금지
