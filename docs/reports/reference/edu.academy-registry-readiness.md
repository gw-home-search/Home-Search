...
| 테스트 품질 | `1.5/1.5` | collector·adapter·ingest·PostGIS projection·observer·LLM contract 집중 테스트 `119 passed`; 전체 AI `544 passed`, coverage `90.30%` |
...
`90.30%` 결과를 사용한다. 부분 테스트만 coverage와 함께 실행하면 저장소 전역
