locals {
  market_news_common_environment = [
    ...
    { name = "HOME_NEWS_NAVER_PROVIDER_MODE", value = "DEVELOPERS" },
    { name = "HOME_NEWS_NAVER_BASE_URL", value = "https://openapi.naver.com" },
    { name = "HOME_NEWS_NAVER_PATH", value = "/v1/search/news.json" },
