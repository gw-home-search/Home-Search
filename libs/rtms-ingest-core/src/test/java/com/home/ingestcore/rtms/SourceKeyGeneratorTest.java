...
class SourceKeyGeneratorTest {
    ...
    void sourceKeyRoundsExclAreaToTwoDecimals() {
        ...
        assertThat(generator.generate("RTMS", roundedDown)).isEqualTo(generator.generate("RTMS", roundedValue));
    }
    ...
    void sourceKeyIgnoresCancellationMetadata() {
        ...
        assertThat(generator.generate("RTMS", canceledDeal)).isEqualTo(generator.generate("RTMS", activeDeal));
    }
    ...
    private OpenApiTradeItem item(String aptSeq, String dealAmount, Double exclArea, String aptDong, String jibun) {
